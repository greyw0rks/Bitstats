...
import { CredIssuance, CredZK } from "../components/Illustrations";
...
const faqs = [
  { q:"How are credentials issued?",     a:"Credentials are issued directly on the blockchain, tied to your BNS name. Each credential is cryptographically signed and stored as part of your identity root." },
      ...
      <main style={{ paddingTop:68 }}>
        ...
        <section style={{ padding:"72px 5%", background:"var(--bg2)", borderBottom:"1px solid var(--border)" }}>
          <div className="container">
            ...
            <p style={{ fontSize:18, color:"var(--text-3)", maxWidth:560, lineHeight:1.7 }}>Immutable, private, and composable. Every credential lives onchain, tied to your BNS name.</p>
          </div>
        </section>
        ...
        <section className="section" style={{ background:"var(--bg2)" }}>
          <div style={{ maxWidth:1100, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:80, alignItems:"center" }} className="split-inner">
            <div style={{ borderRadius:16, aspectRatio:"4/3", overflow:"hidden", background:"#F0FBF8" }}>
              <CredIssuance />
            </div>
            <div>
        ...
        <section className="section">
          <div style={{ maxWidth:1100, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:80, alignItems:"center" }} className="split-inner2">
            ...
            <div style={{ borderRadius:16, aspectRatio:"4/3", overflow:"hidden", background:"#FFFBF5" }}>
              <CredZK />
            </div>
          </div>
